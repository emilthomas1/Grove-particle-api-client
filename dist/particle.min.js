...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _isNan=require("babel-runtime/core-js/number/is-nan"),_isNan2=_interopRequireDefault(_isNan),_typeof2=require("babel-runtime/helpers/typeof"),_typeof3=_interopRequireDefault(_typeof2),_promise=require("babel-runtime/core-js/promise"),_promise2=_interopRequireDefault(_promise),_getPrototypeOf=require("babel-runtime/core-js/object/get-prototype-of"),_getPrototypeOf2=_interopRequireDefault(_getPrototypeOf),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_possibleConstructorReturn2=require("babel-runtime/helpers/possibleConstructorReturn"),_possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2),_inherits2=require("babel-runtime/helpers/inherits"),_inherits3=_interopRequireDefault(_inherits2),_http=require("http"),_http2=_interopRequireDefault(_http),_https=require("https"),_https2=_interopRequireDefault(_https),_url=require("url"),_url2=_interopRequireDefault(_url),_events=require("events"),EventStream=function(e){function t(e,r){var i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2],s=i.debug;(0,_classCallCheck3["default"])(this,t);var n=(0,_possibleConstructorReturn3["default"])(this,(0,_getPrototypeOf2["default"])(t).call(this));return n.uri=e,n.token=r,n.debug=s,n}return(0,_inherits3["default"])(t,e),(0,_createClass3["default"])(t,[{key:"connect",value:function(){var e=this;return new _promise2["default"](function(t,r){var i=_url2["default"].parse(e.uri),s=i.hostname,n=i.protocol,a=i.port,u=i.path;e.origin=n+"//"+s+(a?":"+a:"");var o="https:"===n,l=o?_https2["default"]:_http2["default"],f=l.request({hostname:s,protocol:n,path:u+"?history_limit=30&access_token="+e.token,method:"get",port:a||(o?443:80),avoidFetch:!0,mode:"prefer-streaming"});e.req=f,e.debug&&e.debug(e),f.on("error",function(t){r({error:t,errorDescription:"Network error from "+e.uri})}),f.on("response",function(i){var s=i.statusCode;if(200!==s){var n=function(){var t="";return i.on("data",function(e){return t+=e}),i.on("end",function(){try{t=JSON.parse(t)}catch(i){}e.emit("response",{statusCode:s,body:t});var n="HTTP error "+s+" from "+e.uri;t&&t.error_description&&(n+=" - "+t.error_description),r({statusCode:s,errorDescription:n,body:t}),e.req=null}),{v:void 0}}();if("object"===("undefined"==typeof n?"undefined":(0,_typeof3["default"])(n)))return n.v}e.data="",e.buf="",e.eventName,e.lastEventId,i.on("data",e.parse.bind(e)),i.once("end",function(){e.emit("end"),e.req=null,e.removeAllListeners()}),t(e)}),f.end()})}},{key:"abort",value:function(){this.req&&(this.req.abort(),this.req=null),this.removeAllListeners()}},{key:"parse",value:function(e){this.buf+=e;for(var t=0,r=this.buf.length,i=!1;r>t;){i&&("\n"===this.buf[t]&&++t,i=!1);for(var s=-1,n=-1,a=t;0>s&&r>a;++a){var u=this.buf[a];":"===u?0>n&&(n=a-t):"\r"===u?(i=!0,s=a-t):"\n"===u&&(s=a-t)}if(0>s)break;this.parseEventStreamLine(t,n,s),t+=s+1}t===r?this.buf="":t>0&&(this.buf=this.buf.slice(t))}},{key:"parseEventStreamLine",value:function(e,t,r){if(0===r)try{if(this.data.length>0&&this.eventName){var i=JSON.parse(this.data);i.name=this.eventName,"event"!==this.eventName&&this.emit(this.eventName,i),this.emit("event",i),this.data=""}this.eventName=null}catch(s){}else if(t>0){var n=this.buf.slice(e,e+t),a=0;a=" "!==this.buf[e+t+1]?t+1:t+2,e+=a;var u=r-a,o=this.buf.slice(e,e+u);if("data"===n)this.data+=o+"\n";else if("event"===n)this.eventName=o;else if("id"===n)this.lastEventId=o;else if("retry"===n){var l=parseInt(o,10);(0,_isNan2["default"])(l)||(this.reconnectInterval=l)}}}}]),t}(_events.EventEmitter);exports["default"]=EventStream,module.exports=exports["default"];
},{"babel-runtime/core-js/number/is-nan":3,"babel-runtime/core-js/object/get-prototype-of":6,"babel-runtime/core-js/promise":9,"babel-runtime/helpers/classCallCheck":12,"babel-runtime/helpers/createClass":13,"babel-runtime/helpers/inherits":14,"babel-runtime/helpers/possibleConstructorReturn":15,"babel-runtime/helpers/typeof":16,"events":114,"http":137,"https":137,"url":148}],2:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof2=require("babel-runtime/helpers/typeof"),_typeof3=_interopRequireDefault(_typeof2),_keys=require("babel-runtime/core-js/object/keys"),_keys2=_interopRequireDefault(_keys),_promise=require("babel-runtime/core-js/promise"),_promise2=_interopRequireDefault(_promise),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_superagent=require("superagent"),_superagent2=_interopRequireDefault(_superagent),_superagentPrefix=require("superagent-prefix"),_superagentPrefix2=_interopRequireDefault(_superagentPrefix),_EventStream=require("./EventStream"),_EventStream2=_interopRequireDefault(_EventStream),Particle=function(){function e(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],r=t.baseUrl,u=void 0===r?"https://api.particle.io":r,a=t.clientSecret,i=void 0===a?"particle-api":a,s=t.clientId,n=void 0===s?"particle-api":s,o=t.token;(0,_classCallCheck3["default"])(this,e),this.baseUrl=u,this.clientSecret=i,this.clientId=n,this.prefix=(0,_superagentPrefix2["default"])(u),this.token=o}return(0,_createClass3["default"])(e,[{key:"login",value:function(e){var t=this,r=e.username,u=e.password,a=e.tokenDuration,i=void 0===a?7776e3:a;return this.request({uri:"/oauth/token",form:{username:r,password:u,grant_type:"password",client_id:this.clientId,client_secret:this.clientSecret,expires_in:i},method:"post"}).then(function(e){return t.token=e.body.access_token,e})}},{key:"createUser",value:function(e){var t=e.username,r=e.password;return this.post("/v1/users",{username:t,password:r})}},{key:"removeAccessToken",value:function(e){var t=e.username,r=e.password,u=e.token;return this["delete"]("/v1/access_tokens/"+u,{access_token:u},{username:t,password:r})}},{key:"listAccessTokens",value:function(e){var t=e.username,r=e.password;return this.get("/v1/access_tokens",{username:t,password:r})}},{key:"listDevices",value:function(e){var t=e.auth;return this.get("/v1/devices",t)}},{key:"getDevice",value:function(e){var t=e.deviceId,r=e.auth;return this.get("/v1/devices/"+t,r)}},{key:"claimDevice",value:function(e){var t=e.deviceId,r=e.requestTransfer,u=e.auth;return this.request({uri:"/v1/devices",form:{id:t,request_transfer:!!r},auth:u,method:"post"})}},{key:"removeDevice",value:function(e){var t=e.deviceId,r=e.auth;return this["delete"]("/v1/devices/"+t,null,r)}},{key:"renameDevice",value:function(e){var t=e.deviceId,r=e.name,u=e.auth;return this.put("/v1/devices/"+t,{name:r},u)}},{key:"getClaimCode",value:function(e){var t=e.auth,r=e.iccid;return this.post("/v1/device_claims",{iccid:r},t)}},{key:"validatePromoCode",value:function(e){var t=e.auth,r=e.promoCode;return this.get("/v1/promo_code/"+r,t)}},{key:"changeProduct",value:function(e){var t=e.deviceId,r=e.productId,u=e.shouldUpdate,a=e.auth;return this.put("/v1/devices/"+t,{product_id:r,update_after_claim:u||!1},a)}},{key:"getVariable",value:function(e){var t=e.deviceId,r=e.name,u=e.auth;return this.get("/v1/devices/"+t+"/"+r,u)}},{key:"signalDevice",value:function(e){var t=e.deviceId,r=e.signal,u=e.auth;return this.put("/v1/devices/"+t,{signal:r?"1":"0"},u)}},{key:"flashDevice",value:function(e){var t=e.deviceId,r=e.files,u=e.targetVersion,a=e.auth,i={};return u?i.build_target_version=u:i.latest="true",this.request({uri:"/v1/devices/"+t,files:r,auth:a,form:i,method:"put"})}},{key:"flashTinker",value:function(e){var t=e.deviceId,r=e.auth;return this.put("/v1/devices/"+t,{app:"tinker"},r)}},{key:"compileCode",value:function(e){var t=e.files,r=e.platformId,u=e.targetVersion,a=e.auth,i={platform_id:r};return u?i.build_target_version=u:i.latest="true",this.request({uri:"/v1/binaries",files:t,auth:a,form:i,method:"post"})}},{key:"downloadFirmwareBinary",value:function(e){var t=e.binaryId,r=e.auth,u="/v1/binaries/"+t,a=(0,_superagent2["default"])("get",u);return a.use(this.prefix),this.headers(a,r),this.debug&&this.debug(a),a}},{key:"sendPublicKey",value:function(e){var t=e.deviceId,r=e.key,u=e.algorithm,a=e.auth;return this.post("/v1/provisioning/"+t,{deviceID:t,publicKey:"string"==typeof r?r:r.toString(),filename:"particle-api",order:"manual_"+Date.now(),algorithm:u||"rsa"},a)}},{key:"callFunction",value:function(e){var t=e.deviceId,r=e.name,u=e.argument,a=e.auth;return this.post("/v1/devices/"+t+"/"+r,{args:u},a)}},{key:"getEventStream",value:function(e){var t=e.deviceId,r=e.name,u=e.org,a=e.product,i=e.auth,s=void 0===i?this.token:i,n="/v1/";return u?(n+="orgs/"+u+"/",a?n+="products/"+a+"/":t&&"mine"!==t.toLowerCase()&&(n+="devices/"+t+"/"),n+="events"):n+=t?"mine"===t.toLowerCase()?"devices/events":"devices/"+t+"/events":"events",r&&(n+="/"+encodeURIComponent(r)),new _EventStream2["default"](""+this.baseUrl+n,s,{debug:this.debug}).connect()}},{key:"publishEvent",value:function(e){var t=e.name,r=e.data,u=e.isPrivate,a=e.auth;return this.post("/v1/devices/events",{name:t,data:r,"private":u},a)}},{key:"createWebhook",value:function(e){var t=e.deviceId,r=e.name,u=e.url,a=e.requestType,i=e.headers,s=e.json,n=e.query,o=e.rejectUnauthorized,d=e.webhookAuth,c=e.form,v=e.auth,l={event:r,url:u,requestType:a,headers:i,json:s,query:n,rejectUnauthorized:o,auth:d,form:c};return"mine"===t?l.mydevices=!0:l.deviceid=t,this.post("/v1/webhooks",l,v)}},{key:"deleteWebhook",value:function(e){var t=e.hookId,r=e.auth;return this["delete"]("/v1/webhooks/"+t,null,r)}},{key:"listWebhooks",value:function(e){var t=e.auth;return this.get("/v1/webhooks",t)}},{key:"getUserInfo",value:function(e){var t=e.auth;return this.get("/v1/user",t)}},{key:"setUserInfo",value:function(e){var t=e.stripeToken,r=e.auth;return this.put("/v1/user",{stripe_token:t},r)}},{key:"checkSIM",value:function(e){var t=e.iccid,r=e.auth;return this.head("/v1/sims/"+t,r)}},{key:"activateSIM",value:function(e){var t=e.iccid,r=e.countryCode,u=e.promoCode,a=e.auth;return this.put("/v1/sims/"+t,{country:r,promo_code:u,action:"activate"},a)}},{key:"listBuildTargets",value:function(e){var t=e.auth,r=e.onlyFeatured,u=void 0;return void 0!==r&&(u={featured:!!r}),this.get("/v1/build_targets",t,u)}},{key:"get",value:function(e,t,r){return this.request({uri:e,auth:t,method:"get",query:r})}},{key:"head",value:function(e,t){return this.request({uri:e,auth:t,method:"head"})}},{key:"post",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"post"})}},{key:"put",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"put"})}},{key:"delete",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"delete"})}},{key:"request",value:function(e){var t=this,r=e.uri,u=e.method,a=e.data,i=e.auth,s=void 0===i?this.token:i,n=e.query,o=e.form,d=e.files;return new _promise2["default"](function(e,i){var c=(0,_superagent2["default"])(u,r);c.use(t.prefix),t.headers(c,s),n&&c.query(n),d?((0,_keys2["default"])(d).forEach(function(e,t){c.attach("file"+(t+1),d[e],e)}),o&&(0,_keys2["default"])(o).forEach(function(e){c.field(e,o[e])})):o?(c.type("form"),c.send(o)):a&&c.send(a),t.debug&&t.debug(c),c.end(function(t,u){var a=u&&u.body;if(t){var s=t.status,n=(s?"HTTP error":"Network error")+" "+s+" from "+r;a&&a.error_description&&(n+=" - "+a.error_description),i({statusCode:s,errorDescription:n,error:t,body:a})}else e({body:a,statusCode:u.statusCode})})})}},{key:"headers",value:function(e,t){t&&("object"===("undefined"==typeof t?"undefined":(0,_typeof3["default"])(t))?e.auth(t.username,t.password):e.set({Authorization:"Bearer "+t}))}}]),e}();exports["default"]=Particle,module.exports=exports["default"];
},{"./EventStream":1,"babel-runtime/core-js/object/keys":7,"babel-runtime/core-js/promise":9,"babel-runtime/helpers/classCallCheck":12,"babel-runtime/helpers/createClass":13,"babel-runtime/helpers/typeof":16,"superagent":143,"superagent-prefix":142}],3:[function(require,module,exports){
module.exports={"default":require("core-js/library/fn/number/is-nan"),__esModule:!0};
},{"core-js/library/fn/number/is-nan":23}],4:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}exports.__esModule=!0;var _defineProperty=require("babel-runtime/core-js/object/define-property"),_defineProperty2=_interopRequireDefault(_defineProperty);exports["default"]=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),(0,_defineProperty2["default"])(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}();
},{"babel-runtime/core-js/object/define-property":5}],14:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}exports.__esModule=!0;var _setPrototypeOf=require("babel-runtime/core-js/object/set-prototype-of"),_setPrototypeOf2=_interopRequireDefault(_setPrototypeOf),_create=require("babel-runtime/core-js/object/create"),_create2=_interopRequireDefault(_create),_typeof2=require("babel-runtime/helpers/typeof"),_typeof3=_interopRequireDefault(_typeof2);exports["default"]=function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+("undefined"==typeof t?"undefined":(0,_typeof3["default"])(t)));e.prototype=(0,_create2["default"])(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(_setPrototypeOf2["default"]?(0,_setPrototypeOf2["default"])(e,t):e.__proto__=t)};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}exports.__esModule=!0;var _typeof2=require("babel-runtime/helpers/typeof"),_typeof3=_interopRequireDefault(_typeof2);exports["default"]=function(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!==("undefined"==typeof t?"undefined":(0,_typeof3["default"])(t))&&"function"!=typeof t?e:t};
},{"babel-runtime/helpers/typeof":16}],16:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}exports.__esModule=!0;var _iterator=require("babel-runtime/core-js/symbol/iterator"),_iterator2=_interopRequireDefault(_iterator),_symbol=require("babel-runtime/core-js/symbol"),_symbol2=_interopRequireDefault(_symbol),_typeof="function"==typeof _symbol2["default"]&&"symbol"==typeof _iterator2["default"]?function(e){return typeof e}:function(e){return e&&"function"==typeof _symbol2["default"]&&e.constructor===_symbol2["default"]?"symbol":typeof e};exports["default"]="function"==typeof _symbol2["default"]&&"symbol"===_typeof(_iterator2["default"])?function(e){return"undefined"==typeof e?"undefined":_typeof(e)}:function(e){return e&&"function"==typeof _symbol2["default"]&&e.constructor===_symbol2["default"]?"symbol":"undefined"==typeof e?"undefined":_typeof(e)};
},{"babel-runtime/core-js/symbol":10,"babel-runtime/core-js/symbol/iterator":11}],17:[function(require,module,exports){
...
},{"base64-js":17,"ieee754":115,"isarray":20}],20:[function(require,module,exports){
...
},{"../../modules/_core":39,"../../modules/es6.number.is-nan":102}],24:[function(require,module,exports){
...
},{"../../modules/_core":39,"../../modules/es6.object.create":103}],25:[function(require,module,exports){
...
},{"../../modules/_core":39,"../../modules/es6.object.define-property":104}],26:[function(require,module,exports){
require("../../modules/es6.object.get-prototype-of"),module.exports=require("../../modules/_core").Object.getPrototypeOf;
},{"../../modules/_core":39,"../../modules/es6.object.get-prototype-of":105}],27:[function(require,module,exports){
require("../../modules/es6.object.keys"),module.exports=require("../../modules/_core").Object.keys;
},{"../../modules/_core":39,"../../modules/es6.object.keys":106}],28:[function(require,module,exports){
require("../../modules/es6.object.set-prototype-of"),module.exports=require("../../modules/_core").Object.setPrototypeOf;
},{"../../modules/_core":39,"../../modules/es6.object.set-prototype-of":107}],29:[function(require,module,exports){
...
},{"../modules/_core":39,"../modules/es6.object.to-string":108,"../modules/es6.promise":109,"../modules/es6.string.iterator":110,"../modules/web.dom.iterable":112}],30:[function(require,module,exports){
require("../../modules/es6.symbol"),require("../../modules/es6.object.to-string"),module.exports=require("../../modules/_core").Symbol;
},{"../../modules/_core":39,"../../modules/es6.object.to-string":108,"../../modules/es6.symbol":111}],31:[function(require,module,exports){
require("../../modules/es6.string.iterator"),require("../../modules/web.dom.iterable"),module.exports=require("../../modules/_wks")("iterator");
},{"../../modules/_wks":99,"../../modules/es6.string.iterator":110,"../../modules/web.dom.iterable":112}],32:[function(require,module,exports){
...
var toIObject=require("./_to-iobject"),toLength=require("./_to-length"),toIndex=require("./_to-index");module.exports=function(e){return function(t,r,n){var o,i=toIObject(t),u=toLength(i.length),f=toIndex(n,u);if(e&&r!=r){for(;u>f;)if(o=i[f++],o!=o)return!0}else for(;u>f;f++)if((e||f in i)&&i[f]===r)return e||f;return!e&&-1}};
...
var core=module.exports={version:"2.2.1"};"number"==typeof __e&&(__e=core);
...
var ctx=require("./_ctx"),call=require("./_iter-call"),isArrayIter=require("./_is-array-iter"),anObject=require("./_an-object"),toLength=require("./_to-length"),getIterFn=require("./core.get-iterator-method");module.exports=function(e,r,t,i,n){var o,a,c,l=n?function(){return e}:getIterFn(e),u=ctx(t,i,r?2:1),f=0;if("function"!=typeof l)throw TypeError(e+" is not iterable!");if(isArrayIter(l))for(o=toLength(e.length);o>f;f++)r?u(anObject(a=e[f])[0],a[1]):u(e[f]);else for(c=l.call(e);!(a=c.next()).done;)call(c,u,a.value,r)};
...
var global=require("./_global"),macrotask=require("./_task").set,Observer=global.MutationObserver||global.WebKitMutationObserver,process=global.process,Promise=global.Promise,isNode="process"==require("./_cof")(process),head,last,notify,flush=function(){var e,o;for(isNode&&(e=process.domain)&&e.exit();head;)o=head.fn,o(),head=head.next;last=void 0,e&&e.enter()};if(isNode)notify=function(){process.nextTick(flush)};else if(Observer){var toggle=!0,node=document.createTextNode("");new Observer(flush).observe(node,{characterData:!0}),notify=function(){node.data=toggle=!toggle}}else notify=Promise&&Promise.resolve?function(){Promise.resolve().then(flush)}:function(){macrotask.call(global,flush)};module.exports=function(e){var o={fn:e,next:void 0};last&&(last.next=o),head||(head=o,notify()),last=o};
...
var store=require("./_shared")("wks"),uid=require("./_uid"),Symbol=require("./_global").Symbol,USE_SYMBOL="function"==typeof Symbol;module.exports=function(o){return store[o]||(store[o]=USE_SYMBOL&&Symbol[o]||(USE_SYMBOL?Symbol:uid)("Symbol."+o))};
...
},{"./_export":46}],103:[function(require,module,exports){
var $export=require("./_export");$export($export.S,"Object",{create:require("./_object-create")});
},{"./_export":46,"./_object-create":69}],104:[function(require,module,exports){
var $export=require("./_export");$export($export.S+$export.F*!require("./_descriptors"),"Object",{defineProperty:require("./_object-dp").f});
},{"./_descriptors":42,"./_export":46,"./_object-dp":70}],105:[function(require,module,exports){
...
},{"./_object-gpo":76,"./_object-sap":80,"./_to-object":96}],106:[function(require,module,exports){
var toObject=require("./_to-object"),$keys=require("./_object-keys");require("./_object-sap")("keys",function(){return function(e){return $keys(toObject(e))}});
},{"./_object-keys":78,"./_object-sap":80,"./_to-object":96}],107:[function(require,module,exports){
var $export=require("./_export");$export($export.S,"Object",{setPrototypeOf:require("./_set-proto").set});
},{"./_export":46,"./_set-proto":84}],108:[function(require,module,exports){
...
},{"./_global":49,"./_hide":51,"./_iterators":64,"./_wks":99,"./es6.array.iterator":101}],113:[function(require,module,exports){
(function (Buffer){
...
},{"../../is-buffer/index.js":117}],114:[function(require,module,exports){
...
},{"events":114,"inherits":116,"readable-stream/duplex.js":127,"readable-stream/passthrough.js":133,"readable-stream/readable.js":134,"readable-stream/transform.js":135,"readable-stream/writable.js":136}],126:[function(require,module,exports){
...
},{"./_stream_readable":130,"./_stream_writable":132,"core-util-is":113,"inherits":116,"process-nextick-args":118}],129:[function(require,module,exports){
...
},{"./_stream_transform":131,"core-util-is":113,"inherits":116}],130:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":128,"_process":119,"buffer":19,"core-util-is":113,"events":114,"inherits":116,"isarray":126,"process-nextick-args":118,"stream":125,"string_decoder/":141,"util":18}],131:[function(require,module,exports){
...
},{"./_stream_duplex":128,"core-util-is":113,"inherits":116}],132:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":128,"_process":119,"buffer":19,"core-util-is":113,"events":114,"inherits":116,"process-nextick-args":118,"stream":125,"util-deprecate":150}],133:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":128,"./lib/_stream_passthrough.js":129,"./lib/_stream_readable.js":130,"./lib/_stream_transform.js":131,"./lib/_stream_writable.js":132,"stream":125}],135:[function(require,module,exports){
...
},{"./lib/request":139,"builtin-status-codes":21,"url":148,"xtend":151}],138:[function(require,module,exports){
(function (global){
...
},{"./capability":138,"./response":140,"_process":119,"buffer":19,"inherits":116,"stream":125,"to-arraybuffer":147}],140:[function(require,module,exports){
(function (process,global,Buffer){
...
},{"./capability":138,"_process":119,"buffer":19,"inherits":116,"stream":125}],141:[function(require,module,exports){
...
},{"./is-object":144,"./request":146,"./request-base":145,"emitter":22,"reduce":124}],144:[function(require,module,exports){
...
},{"buffer":19}],148:[function(require,module,exports){
...
},{"./util":149,"punycode":120,"querystring":123}],149:[function(require,module,exports){
